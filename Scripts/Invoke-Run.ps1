...
.DESCRIPTION
    This command sends a single command to `Start-Process` in a way that is standardized. 
    For convenience, you can use the `Cmd` parameter, passing a single string that contains your executable and parameters; see examples.
