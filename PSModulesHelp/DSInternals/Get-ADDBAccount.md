...
```
```PowerShell
Get-ADDBAccount [-BootKey <Byte[]>] -DatabasePath <String> -DistinguishedName <String> [-LogPath <String>] [<CommonParameters>]
```
```PowerShell
Get-ADDBAccount [-BootKey <Byte[]>] -DatabasePath <String> [-LogPath <String>] -ObjectGuid <Guid> [<CommonParameters>]
```
```PowerShell
Get-ADDBAccount [-BootKey <Byte[]>] -DatabasePath <String> [-LogPath <String>] -ObjectSid <SecurityIdentifier> [<CommonParameters>]
```
```PowerShell
Get-ADDBAccount [-SamAccountName] <String> [-BootKey <Byte[]>] -DatabasePath <String> [-LogPath <String>] [<CommonParameters>]
```
