...
### Syntax
```PowerShell
Enable-ADDBAccount -DatabasePath <String> -DistinguishedName <String> [-Force] [-LogPath <String>] [-SkipMetaUpdate] [<CommonParameters>]
```
```PowerShell
Enable-ADDBAccount -DatabasePath <String> [-Force] [-LogPath <String>] -ObjectGuid <Guid> [-SkipMetaUpdate] [<CommonParameters>]
```
```PowerShell
Enable-ADDBAccount -DatabasePath <String> [-Force] [-LogPath <String>] -ObjectSid <SecurityIdentifier> [-SkipMetaUpdate] [<CommonParameters>]
```
```PowerShell
Enable-ADDBAccount [-SamAccountName] <String> -DatabasePath <String> [-Force] [-LogPath <String>] [-SkipMetaUpdate] [<CommonParameters>]
```
