Get-NcNameServiceCacheUnixUserSettings
--------------------------------------
...
```PowerShell
PS E:\Debug> Get-NcNameServiceCacheUnixUserSettings
IsEnabled                       : True
...
API: name-service-cache-unix-user-settings-get
Family:  vserver
...
### Syntax
```PowerShell
Get-NcNameServiceCacheUnixUserSettings [-VserverContext <String>] [-Controller <NcController[]>] [-InformationAction <ActionPreference>] [-InformationVariable <String>] [-PipelineVariable 
```
```PowerShell
