...
```PowerShell
Remove-NcExportRule dlamotta0101 1
Removing the export rule with index 1 from the export policy dlamotta0101.
```
...
### Syntax
```PowerShell
Remove-NcExportRule [-Policy] <String> [-Index] <UInt32> [-VserverContext <String>] [-Controller <NcController[]>] [-InformationAction <ActionPreference>] [-InformationVariable <String>] 
```
```PowerShell
