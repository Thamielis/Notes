...
### Parameters
#### **NodeName**
The node on which the Ood Performance Statistics needs to be cleared.
...
API: ha-interconnect-ood-clear-performance-statistics
Family: cluster
...
### Syntax
```PowerShell
Clear-NcHaInterconnectOodPerformanceStatistics [-NodeName] <String> [-Controller <NcController[]>] [-InformationAction <ActionPreference>] [-InformationVariable <String>] [-PipelineVariable 
```
```PowerShell
