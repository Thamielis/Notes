...
### Parameters
#### **NodeName**
The node on which the Ood Optimization needs to be disabled.
...
API: ha-interconnect-ood-optimization-off
Family: cluster
...
### Syntax
```PowerShell
Disable-NcHaInterconnectOodOptimization [-NodeName] <String> [-Controller <NcController[]>] [-InformationAction <ActionPreference>] [-InformationVariable <String>] [-PipelineVariable 
```
```PowerShell
