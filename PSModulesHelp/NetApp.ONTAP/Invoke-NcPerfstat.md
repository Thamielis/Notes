...
#### **Node**
Restrict the perfstat to run on the given node or nodes.  Data ONTAP wildcards are accepted
...
### Syntax
```PowerShell
Invoke-NcPerfstat [[-Directory] <String>] [[-Node] <String[]>] [-SampleInterval <Int32>] [-Time <Int32>] [-Iterations <Int32>] [-IterationSleepTime <Int32>] [-Controller <NcController[]>] 
```
```PowerShell
