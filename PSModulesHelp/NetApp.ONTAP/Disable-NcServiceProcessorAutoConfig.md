...
Disable-NcServiceProcessorAutoConfig -AddressFamily "IPv4"
Disable autoconfig on the cluster
...
API: service-processor-auto-configuration-disable
Family: cluster
...
### Syntax
```PowerShell
Disable-NcServiceProcessorAutoConfig [-AddressFamily] <String> [-Node <String>] [-Controller <NcController[]>] [-InformationAction <ActionPreference>] [-InformationVariable <String>] 
```
```PowerShell
