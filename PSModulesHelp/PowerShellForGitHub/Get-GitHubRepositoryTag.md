...
### Syntax
```PowerShell
Get-GitHubRepositoryTag [-OwnerName <String>] [-RepositoryName <String>] [-AccessToken <String>] [<CommonParameters>]
```
```PowerShell
Get-GitHubRepositoryTag -Uri <String> [-AccessToken <String>] [<CommonParameters>]
```
