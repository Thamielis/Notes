...
### Synopsis
Enable autosupport on the SP module
...
Enable-NcServiceProcessorAutoSupport
Enable service processor autosupport for the cluster

NcController                                                          IsEnabled                      IsEnabledSpecified
------------                                                          ---------                      ------------------
10.225.215.73                                                              True                                    True
...
### Syntax
```PowerShell
Enable-NcServiceProcessorAutoSupport [-Controller <NcController[]>] [-InformationAction <ActionPreference>] [-InformationVariable <String>] [-PipelineVariable <String>] [-ZapiRetryCount 
```
```PowerShell
