Get-NcNameServiceCacheUnixGroupSettings
---------------------------------------
...
```PowerShell
PS E:\Debug> GetNcNameServiceCacheUnixGroupSettings
IsEnabled                       : True
...
API: name-service-cache-unix-group-settings-get
Family: vserver
...
### Syntax
```PowerShell
Get-NcNameServiceCacheUnixGroupSettings [-VserverContext <String>] [-Controller <NcController[]>] [-InformationAction <ActionPreference>] [-InformationVariable <String>] [-PipelineVariable 
```
```PowerShell
