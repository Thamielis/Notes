...
Add-NcVserverProtocol -Name pester -Protocol cifs
Add cifs to the list of allowed protocols for the given vserver.
...
### Syntax
```PowerShell
Add-NcVserverProtocol [-Name] <String> [-Protocol] <String[]> [-Controller <NcController[]>] [-InformationAction <ActionPreference>] [-InformationVariable <String>] [-PipelineVariable 
```
```PowerShell
