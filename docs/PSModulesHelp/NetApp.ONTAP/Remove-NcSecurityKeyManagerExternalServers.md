Remove-NcSecurityKeyManagerExternalServers
------------------------------------------
...
#### **KeyServers**
The key management servers to remove.
...
API: security-key-manager-external-remove-servers
...
### Syntax
```PowerShell
Remove-NcSecurityKeyManagerExternalServers [-Vserver] <String> [[-KeyServers] <String[]>] [-Scope <String>] [-Controller <NcController[]>] [-InformationAction <ActionPreference>] 
```
```PowerShell
