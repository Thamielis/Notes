...
API: vm-disk-object-store-destroy
...
### Syntax
```PowerShell
Remove-NcVmDiskObjectStore [-Node] <String> [-ObjectStoreName] <String> [-UpdatePartner] [-Controller <NcController[]>] [-InformationAction <ActionPreference>] [-InformationVariable <String>] 
```
```PowerShell
