...
### Related Links
* [Start-NcCifsServer](Start-NcCifsServer)
...
Stop-NcCifsServer
Stop the CIFS server on the current Vserver.
...
### Syntax
```PowerShell
Stop-NcCifsServer [-VserverContext <String>] [-Controller <NcController[]>] [-InformationAction <ActionPreference>] [-InformationVariable <String>] [-PipelineVariable <String>] 
```
```PowerShell
