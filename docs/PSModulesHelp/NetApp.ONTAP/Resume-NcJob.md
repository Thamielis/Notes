...
### Parameters
#### **Id**
The ID of the job to resume. This parameter is supported with Ontapi only.
...
### Syntax
```PowerShell
Resume-NcJob [-Id] <Decimal> [-VserverContext <String>] [-Uuid <String>] [-Controller <NcController[]>] [-InformationAction <ActionPreference>] [-InformationVariable <String>] 
```
```PowerShell
