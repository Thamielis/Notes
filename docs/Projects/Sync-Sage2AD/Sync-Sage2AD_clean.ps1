...
function New-SageObject {
    ...
    $UserData = New-Object PSObject -Property ([ordered]@{
            ...
            Austritt            = $Austritt #$sUser.AUSTRITT
...
function Set-Runspace {
    ...
    $global:SyncHash.Runspace.Modules = $global:SyncHash.Config.Imports.Names.Modules
...
try {
    Sync-Sage2AD -GetMailDifferences -ExportSyncHashs
}
catch {
    $ErrorInfo = $_
    $ErrorMessage = $_.Exception.Message
