---
created: 2025-07-22T12:11:01 (UTC +02:00)
tags: []
source: https://training.github.com/downloads/de/github-git-cheat-sheet/
author: 
---

# GitHub Git Spickzettel - GitHub Cheatsheets

- [GitHub Git Spickzettel - GitHub Cheatsheets](#github-git-spickzettel---github-cheatsheets)
  - [Git installieren](#git-installieren)
    - [GitHub für Windows](#github-für-windows)
    - [GitHub für Mac](#github-für-mac)
    - [Git für alle Plattformen](#git-für-alle-plattformen)
  ...
  - [Änderungen gruppieren](#änderungen-gruppieren)
  - [Dateinamen refaktorisieren](#dateinamen-refaktorisieren)
  - [Tracking unterdrücken](#tracking-unterdrücken)
  - [Fragmente speichern](#fragmente-speichern)
  - [Historie überprüfen](#historie-überprüfen)
  - [Commits wiederholen](#commits-wiederholen)
  - [Änderungen synchronisieren](#änderungen-synchronisieren)
