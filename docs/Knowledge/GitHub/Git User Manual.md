---
created: 2025-07-22T11:35:37 (UTC +02:00)
tags: []
source: file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html
author: 
---
...
- [Git User Manual](#git-user-manual)
  ...
  - [Chapter 1. Repositories and Branches](#chapter1repositories-and-branches)
  ...
  - [Chapter 2. Exploring Git history](#chapter2exploring-git-history)
    ...
    - [Examples](#examples)
      ...
      - [Showing commits unique to a given branch](#showing-commits-unique-to-a-given-branch)
      - [Creating a changelog and tarball for a software release](#creating-a-changelog-and-tarball-for-a-software-release)
    - [Finding commits referencing a file with given content](#finding-commits-referencing-a-file-with-given-content)
  - [Chapter 3. Developing with Git](#chapter3developing-with-git)
  ...
  - [Fixing mistakes](#fixing-mistakes)
    ...
    - [Temporarily setting aside work in progress](#temporarily-setting-aside-work-in-progress)
  ...
  - [Chapter 4. Sharing development with others](#chapter4sharing-development-with-others)
  ...
  - [Public Git repositories](#public-git-repositories)
    ...
    - [Exporting a Git repository via the Git protocol](#exporting-a-git-repository-via-the-git-protocol)
    ...
    - [Allowing web browsing of a repository](#allowing-web-browsing-of-a-repository)
  - [How to get a Git repository with minimal history](#how-to-get-a-git-repository-with-minimal-history)
  - [Examples](#examples-1)
    - [Maintaining topic branches for a Linux subsystem maintainer](#maintaining-topic-branches-for-a-linux-subsystem-maintainer)
  - [Chapter 5. Rewriting history and maintaining patch series](#chapter5rewriting-history-and-maintaining-patch-series)
  ...
  - [Rewriting a single commit](#rewriting-a-single-commit)
  - [Reordering or selecting from a patch series](#reordering-or-selecting-from-a-patch-series)
  - [Using interactive rebases](#using-interactive-rebases)
  - [Other tools](#other-tools)
  - [Problems with rewriting history](#problems-with-rewriting-history)
  - [Why bisecting merge commits can be harder than bisecting linear history](#why-bisecting-merge-commits-can-be-harder-than-bisecting-linear-history)
  - [Chapter 6. Advanced branch management](#chapter6advanced-branch-management)
  ...
  - [Chapter 7. Git concepts](#chapter7git-concepts)
  ...
  - [The index](#the-index)
  - [Chapter 8. Submodules](#chapter8submodules)
    - [Note](#note)
    - [Note](#note-1)
  - [Pitfalls with submodules](#pitfalls-with-submodules)
    - [Note](#note-2)
  - [Chapter 9. Low-level Git operations](#chapter9low-level-git-operations)
  ...
  - [Chapter 10. Hacking Git](#chapter10hacking-git)
  - [Object storage format](#object-storage-format)
  - [A birds-eye view of Git’s source code](#a-birds-eye-view-of-gits-source-code)
  - [Chapter 11. Git Glossary](#chapter11git-glossary)
  - [Git explained](#git-explained)
  - [Appendix A. Git Quick Reference](#appendixagit-quick-reference)
  ...
  - [Appendix B. Notes and todo list for this manual](#appendixbnotes-and-todo-list-for-this-manual)
  - [Todo list](#todo-list)
...
[Chapter 1, _Repositories and Branches_](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#repositories-and-branches "Chapter 1. Repositories and Branches") and [Chapter 2, _Exploring Git history_](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#exploring-git-history "Chapter 2. Exploring Git history") explain how to fetch and study a project using git—read these chapters to learn how to build and test a particular version of a software project, search for regressions, and so on.

People needing to do actual development will also want to read [Chapter 3, _Developing with Git_](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#Developing-With-git "Chapter 3. Developing with Git") and [Chapter 4, _Sharing development with others_](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#sharing-development "Chapter 4. Sharing development with others").

Further chapters cover more specialized topics.

Comprehensive reference documentation is available through the man pages, or [git-help(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-help.html) command. For example, for the command `git clone <repo>`, you can either use:
...
With the latter, you can use the manual viewer of your choice; see [git-help(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-help.html) for more information.

See also [Appendix A, _Git Quick Reference_](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#git-quick-start "Appendix A. Git Quick Reference") for a brief overview of Git commands, without any explanation.

Finally, see [Appendix B, _Notes and todo list for this manual_](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#todo "Appendix B. Notes and todo list for this manual") for ways that you can help make this manual more complete.
...
The best way to get one is by using the [git-clone(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-clone.html) command to download a copy of an existing repository. If you don’t already have a project in mind, here are some interesting examples:
...
The clone command creates a new directory named after the project (`git` or `linux` in the examples above). After you cd into this directory, you will see that it contains a copy of the project files, called the [working tree](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_working_tree), together with a special top-level directory named `.git`, which contains all the information about the history of the project.

### How to check out a different version of a project

Git is best thought of as a tool for storing the history of a collection of files. It stores the history as a compressed collection of interrelated snapshots of the project’s contents. In Git each such version is called a [commit](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit).

Those snapshots aren’t necessarily all arranged in a single line from oldest to newest; instead, work may simultaneously proceed along parallel lines of development, called [branches](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_branch), which may merge and diverge.

A single Git repository can track development on multiple branches. It does this by keeping a list of [heads](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_head) which reference the latest commit on each branch; the [git-branch(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-branch.html) command shows you the list of branch heads:
...
Most projects also use [tags](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_tag). Tags, like heads, are references into the project’s history, and can be listed using the [git-tag(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-tag.html) command:
...
Create a new branch head pointing to one of these versions and check it out using [git-switch(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-switch.html):

```shell
git switch -c new v2.6.13
```

The working directory then reflects the contents that the project had when it was tagged v2.6.13, and [git-branch(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-branch.html) shows two branches, with an asterisk marking the currently checked-out branch:
...
Every change in the history of a project is represented by a commit. The [git-show(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-show.html) command shows the most recent commit on the current branch:
...
The best way to see how this works is using the [gitk(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/gitk.html) command; running gitk now on a Git repository and looking for merge commits will help understand how Git organizes history.
...
In this example, "origin" is called a remote repository, or "remote" for short. The branches of this repository are called "remote branches" from our point of view. The remote-tracking branches listed above were created based on the remote branches at clone time and will be updated by `git fetch` (hence `git pull`) and `git push`. See [the section called “Updating a repository with git fetch”](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#Updating-a-repository-With-git-fetch "Updating a repository with git fetch") for details.
...
You can also check out `origin/todo` directly to examine it or write a one-off patch. See [detached head](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#detached-head "Examining an old version without creating a new branch").
...
(Newly created refs are actually stored in the `.git/refs` directory, under the path given by their name. However, for efficiency reasons they may also be packed together in a single file; see [git-pack-refs(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-pack-refs.html)).
...
For the complete list of paths which Git checks for references, and the order it uses to decide which to choose when there are multiple references with the same shorthand name, see the "SPECIFYING REVISIONS" section of [gitrevisions(7)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/gitrevisions.html).
...
You can also track branches from repositories other than the one you cloned from, using [git-remote(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-remote.html):
...
This is what causes Git to track the remote’s branches; you may modify or delete these configuration options by editing `.git/config` with a text editor. (See the "CONFIGURATION FILE" section of [git-config(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-config.html) for details.)
...
Suppose version 2.6.18 of your project worked, but the version at "master" crashes. Sometimes the best way to find the cause of such a regression is to perform a brute-force search through the project’s history to find the particular commit that caused the problem. The [git-bisect(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-bisect.html) command can help you do this:
...
After about 13 tests (in this case), it will output the commit id of the guilty commit. You can then examine the commit with [git-show(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-show.html), find out who wrote it, and mail them your bug report with the commit id. Finally, run
...
There are also ways to automate the bisecting process if you have a test script that can tell a good from a bad commit. See [git-bisect(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-bisect.html) for more information about this and other `git bisect` features.
...
- tag name: refers to the commit pointed to by the given tag (we’ve seen branches and tags are special cases of [references](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#how-git-stores-references "Naming branches, tags, and other references")).
- HEAD: refers to the head of the current branch

There are many more; see the "SPECIFYING REVISIONS" section of the [gitrevisions(7)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/gitrevisions.html) man page for the complete list of ways to name revisions. Some examples:
...
The [git-rev-parse(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-rev-parse.html) command is a low-level command that is occasionally useful for translating some name for a commit to the object name for that commit:
...
This creates a "lightweight" tag. If you would also like to include a comment with the tag, and possibly sign it cryptographically, then you should create a tag object instead; see the [git-tag(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-tag.html) man page for details.

### Browsing revisions

The [git-log(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-log.html) command can show lists of commits. On its own, it shows all commits reachable from the parent commit; but you can also make more specific requests:
...
See the `--pretty` option in the [git-log(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-log.html) man page for more display options.
...
You can generate diffs between any two versions using [git-diff(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-diff.html):
...
Sometimes what you want instead is a set of patches; for this you can use [git-format-patch(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-format-patch.html):
...
Alternatively, you may often see this sort of thing done with the lower-level command [git-rev-list(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-rev-list.html), which just lists the SHA-1’s of all the given commits:
...
or you can use [git-name-rev(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-name-rev.html), which will give the commit a name based on any tag it finds pointing to one of the commit’s descendants:
...
The [git-describe(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-describe.html) command does the opposite, naming the revision using a tag on which the given commit is based:
...
If you just want to verify whether a given tagged version contains a given commit, you could use [git-merge-base(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-merge-base.html):
...
As yet another alternative, the [git-show-branch(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-show-branch.html) command lists the commits reachable from its arguments with a display on the left-hand side that indicates which arguments that commit is reachable from. So, if you run something like
...
We can list all the heads in this repository with [git-show-ref(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-show-ref.html):
...
(See [gitrevisions(7)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/gitrevisions.html) for explanations of commit-selecting syntax such as `--not`.)

#### Creating a changelog and tarball for a software release

The [git-archive(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-archive.html) command can create a tar or zip archive from any version of a project; for example:

```shell
git archive -o latest.tar.gz --prefix=project/ HEAD
```

will use HEAD to produce a gzipped tar archive in which each filename is preceded by `project/`. The output file format is inferred from the output file extension if possible, see [git-archive(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-archive.html) for details.
...
Figuring out why this works is left as an exercise to the (advanced) student. The [git-log(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-log.html), [git-diff-tree(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-diff-tree.html), and [git-hash-object(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-hash-object.html) man pages may prove helpful.

## Chapter 3. Developing with Git

### Telling Git your name

Before creating any commits, you should introduce yourself to Git. The easiest way to do so is to use [git-config(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-config.html):
...
See the "CONFIGURATION FILE" section of [git-config(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-config.html) for details on the configuration file. The file is plain text, so you can also edit it with your favorite editor.
...
You can also use [git-gui(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-gui.html) to create commits, view changes in the index and the working tree files, and individually select diff hunks for inclusion in the index (by right-clicking on the diff hunk and choosing "Stage Hunk For Commit").

### Creating good commit messages

Though not required, it’s a good idea to begin the commit message with a single short (no more than 50 characters) line summarizing the change, followed by a blank line and then a more thorough description. The text up to the first blank line in a commit message is treated as the commit title, and that title is used throughout Git. For example, [git-format-patch(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-format-patch.html) turns a commit into email, and it uses the title on the Subject line and the rest of the commit in the body.
...
See [gitignore(5)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/gitignore.html) for a detailed explanation of the syntax. You can also place .gitignore files in other directories in your working tree, and they will apply to those directories and their subdirectories. The `.gitignore` files can be added to your repository like any other files (just run `git add .gitignore` and `git commit`, as usual), which is convenient when the exclude patterns (such as patterns matching build output files) would also make sense for other users who clone your repository.

If you wish the exclude patterns to affect only certain repositories (instead of every repository for a given project), you may instead put them in a file in your repository named `.git/info/exclude`, or in any file specified by the `core.excludesFile` configuration variable. Some Git commands can also take exclude patterns directly on the command line. See [gitignore(5)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/gitignore.html) for the details.

### How to merge

You can rejoin two diverging branches of development using [git-merge(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-merge.html):
...
Files with conflicts are marked specially in the index, so until you resolve the problem and update the index, [git-commit(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-commit.html) will fail:
...
Also, [git-status(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-status.html) will list those files as "unmerged", and the files with conflicts will have conflict markers added, like this:
...
All of the changes that Git was able to merge automatically are already added to the index file, so [git-diff(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-diff.html) shows only the conflicts. It uses an unusual syntax:
...
The [git-log(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-log.html) and [gitk(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/gitk.html) commands also provide special help for merges:
...
You may also use [git-mergetool(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-mergetool.html), which lets you merge the unmerged files using external tools such as Emacs or kdiff3.
...
Creating a new commit that reverts an earlier change is very easy; just pass the [git-revert(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-revert.html) command a reference to the bad commit; for example, to revert the most recent commit:
...
In this case Git will attempt to undo the old change while leaving intact any changes made since then. If more recent changes overlap with the changes to be reverted, then you will be asked to fix conflicts manually, just as in the case of [resolving a merge](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#resolving-a-merge "Resolving a merge").

### Fixing a mistake by rewriting history

If the problematic commit is the most recent commit, and you have not yet made that commit public, then you may just [destroy it using `git reset`](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#undoing-a-merge "Undoing a merge").

Alternatively, you can edit the working directory and update the index to fix your mistake, just as if you were going to [create a new commit](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#how-to-make-a-commit "How to make a commit"), then run
...
Again, you should never do this to a commit that may already have been merged into another branch; use [git-revert(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-revert.html) instead in that case.

It is also possible to replace commits further back in the history, but this is an advanced topic to be left for [another chapter](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#cleaning-up-history "Chapter 5. Rewriting history and maintaining patch series").

### Checking out an old version of a file

In the process of undoing a previous bad change, you may find it useful to check out an older version of a particular file using [git-restore(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-restore.html). The command
...
If you just want to look at an old version of the file, without modifying the working directory, you can do that with [git-show(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-show.html):
...
While you are in the middle of working on something complicated, you find an unrelated but obvious and trivial bug. You would like to fix it before continuing. You can use [git-stash(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-stash.html) to save the current state of your work, and after fixing the bug (or, optionally after doing so on a different branch and then coming back), unstash the work-in-progress changes.
...
On large repositories, Git depends on compression to keep the history information from taking up too much space on disk or in memory. Some Git commands may automatically run [git-gc(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-gc.html), so you don’t have to worry about running it manually. However, compressing a large repository may take a while, so you may want to call `gc` explicitly to avoid automatic compression kicking in when it is not convenient.

## Ensuring reliability

### Checking the repository for corruption

The [git-fsck(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-fsck.html) command runs a number of self-consistency checks on the repository, and reports on any problems. This may take some time.
...
Say you modify a branch with [`git reset --hard`](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#fixing-mistakes "Fixing mistakes"), and then realize that the branch was the only reference you had to that point in history.
...
The reflogs are kept by default for 30 days, after which they may be pruned. See [git-reflog(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-reflog.html) and [git-gc(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-gc.html) to learn how to control this pruning, and see the "SPECIFYING REVISIONS" section of [gitrevisions(7)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/gitrevisions.html) for details.
...
In some situations the reflog may not be able to save you. For example, suppose you delete a branch, then realize you need the history it contained. The reflog is also deleted; however, if you have not yet pruned the repository, then you may still be able to find the lost commits in the dangling objects that `git fsck` reports. See [the section called “Dangling objects”](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#dangling-objects "Dangling objects") for the details.
...
We have already seen [how to keep remote-tracking branches up to date](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#Updating-a-repository-With-git-fetch "Updating a repository with git fetch") with [git-fetch(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-fetch.html), and how to merge two branches. So you can merge in changes from the original repository’s master branch with:
...
However, the [git-pull(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-pull.html) command provides a way to do this in one step:
...
More generally, a branch that is created from a remote-tracking branch will pull by default from that branch. See the descriptions of the `branch.<name>.remote` and `branch.<name>.merge` options in [git-config(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-config.html), and the discussion of the `--track` option in [git-checkout(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-checkout.html), to learn how to control these defaults.
...
(But note that no such commit will be created in the case of a [fast-forward](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#fast-forwards "Fast-forward merges"); instead, your branch will just be updated to point to the latest commit from the upstream branch.)
...
First, use [git-format-patch(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-format-patch.html); for example:
...
You can then import these into your mail client and send them by hand. However, if you have a lot to send at once, you may prefer to use the [git-send-email(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-send-email.html) script to automate the process. Consult the mailing list for your project first to determine their requirements for submitting patches.

## Importing patches to a project

Git also provides a tool called [git-am(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-am.html) (am stands for "apply mailbox"), for importing such an emailed series of patches. Just save all of the patch-containing messages, in order, into a single mailbox file, say `patches.mbox`, then run

```
git am -3 patches.mbox
```

Git will apply each patch in order; if any conflicts are found, it will stop, and you can fix the conflicts as described in "[Resolving a merge](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#resolving-a-merge "Resolving a merge")". (The `-3` option tells Git to perform a merge; if you would prefer it just to abort and leave your tree and index untouched, you may omit that option.)
...
Another way to submit changes to a project is to tell the maintainer of that project to pull the changes from your repository using [git-pull(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-pull.html). In the section "[Getting updates with `git pull`](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#getting-updates-With-git-pull "Getting updates with git pull")" we described this as a way to get updates from the "main" repository, but it works just as well in the other direction.
...
If someone else administers the server, they should tell you what directory to put the repository in, and what `git://` URL it will appear at. You can then skip to the section "[Pushing changes to a public repository](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#pushing-changes-to-a-public-repository "Pushing changes to a public repository")", below.

Otherwise, all you need to do is start [git-daemon(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-daemon.html); it will listen on port 9418. By default, it will allow access to any directory that looks like a Git directory and contains the magic file git-daemon-export-ok. Passing some directory paths as `git daemon` arguments will further restrict the exports to those paths.

You can also run `git daemon` as an inetd service; see the [git-daemon(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-daemon.html) man page for details. (See especially the examples section.)
...
(For an explanation of the last two lines, see [git-update-server-info(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-update-server-info.html) and [githooks(5)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/githooks.html).)
...
(See also [setup-git-server-over-http](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/howto/setup-git-server-over-http.html) for a slightly more sophisticated setup using WebDAV which also allows pushing over HTTP.)

### Pushing changes to a public repository

Note that the two techniques outlined above (exporting via [http](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#exporting-via-http "Exporting a git repository via HTTP") or [git](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#exporting-via-git "Exporting a Git repository via the Git protocol")) allow other maintainers to fetch your latest changes, but they do not allow write access, which you will need to update the public repository with the latest changes created in your private repository.

The simplest way to do this is using [git-push(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-push.html) and ssh; to update the remote branch named `master` with the latest state of your branch named `master`, run
...
As with `git fetch`, `git push` will complain if this does not result in a [fast-forward](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#fast-forwards "Fast-forward merges"); see the following section for details on handling this case.

Note that the target of a `push` is normally a [bare](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_bare_repository) repository. You can also push to a repository that has a checked-out working tree, but a push to update the currently checked-out branch is denied by default to prevent confusion. See the description of the receive.denyCurrentBranch option in [git-config(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-config.html) for details.
...
See the explanations of the `remote.<name>.url`, `branch.<name>.remote`, and `remote.<name>.push` options in [git-config(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-config.html) for details.

### What to do when a push fails

If a push would not result in a [fast-forward](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#fast-forwards "Fast-forward merges") of the remote branch, then it will fail with an error like:
...
- use `git commit --amend` to replace already-published commits (as in [the section called “Fixing a mistake by rewriting history”](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#fixing-a-mistake-by-rewriting-history "Fixing a mistake by rewriting history")), or
- use `git rebase` to rebase any already-published commits (as in [the section called “Keeping a patch series up to date using git rebase”](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#using-git-rebase "Keeping a patch series up to date using git rebase")).
...
Normally whenever a branch head in a public repository is modified, it is modified to point to a descendant of the commit that it pointed to before. By forcing a push in this situation, you break that convention. (See [the section called “Problems with rewriting history”](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#problems-With-rewriting-history "Problems with rewriting history").)
...
It’s also possible for a push to fail in this way when other people have the right to push to the same repository. In that case, the correct solution is to retry the push after first updating your work: either by a pull, or by a fetch followed by a rebase; see the [next section](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#setting-up-a-shared-repository "Setting up a shared repository") and [gitcvs-migration(7)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/gitcvs-migration.html) for more.

### Setting up a shared repository

Another way to collaborate is by using a model similar to that commonly used in CVS, where several developers with special rights all push to and pull from a single shared repository. See [gitcvs-migration(7)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/gitcvs-migration.html) for instructions on how to set this up.
...
The [git-instaweb(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-instaweb.html) command provides a simple way to start browsing the repository using gitweb. The default server when using instaweb is lighttpd.

See the file gitweb/INSTALL in the Git source tree and [gitweb(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/gitweb.html) for instructions on details setting up a permanent installation with a CGI or Perl capable server.

## How to get a Git repository with minimal history

A [shallow clone](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_shallow_clone), with its truncated history, is useful when one is interested only in recent history of a project and getting full history from the upstream is expensive.

A [shallow clone](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_shallow_clone) is created by specifying the [git-clone(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-clone.html) `--depth` switch. The depth can later be changed with the [git-fetch(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-fetch.html) `--depth` switch, or full history restored with `--unshallow`.
...
Linus’s tree will be stored in the remote-tracking branch named origin/master, and can be updated using [git-fetch(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-fetch.html); you can track other public trees using [git-remote(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-remote.html) to set up a "remote" and [git-fetch(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-fetch.html) to keep them up to date; see [Chapter 1, _Repositories and Branches_](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#repositories-and-branches "Chapter 1. Repositories and Branches").

Now create the branches in which you are going to work; these start out at the current tip of origin/master branch, and should be set up (using the `--track` option to [git-branch(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-branch.html)) to merge changes in from Linus by default.
...
These can be easily kept up to date using [git-pull(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-pull.html).
...
A few configuration variables (see [git-config(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-config.html)) can make it easy to push both branches to your public tree. (See [the section called “Setting up a public repository”](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#setting-up-a-public-repository "Setting up a public repository").)
...
Then you can push both the test and release trees using [git-push(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-push.html):
...
After pushing your work to `mytree`, you can use [git-request-pull(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-request-pull.html) to prepare a "please pull" request message to send to Linus:
...
However, if you prefer to keep the history in mywork a simple series of commits without any merges, you may instead choose to use [git-rebase(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-rebase.html):
...
If you need to reorder or edit a number of commits in a branch, it may be easier to use `git rebase -i`, which allows you to reorder and squash commits, as well as marking them for individual editing during the rebase. See [the section called “Using interactive rebases”](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#interactive-rebase "Using interactive rebases") for details, and [the section called “Reordering or selecting from a patch series”](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#reordering-patch-series "Reordering or selecting from a patch series") for alternatives.

## Rewriting a single commit

We saw in [the section called “Fixing a mistake by rewriting history”](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#fixing-a-mistake-by-rewriting-history "Fixing a mistake by rewriting history") that you can replace the most recent commit using
...
If you need to amend commits from deeper in your history, you can use [interactive rebase’s `edit` instruction](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#interactive-rebase "Using interactive rebases").
...
Then modify, reorder, or eliminate patches as needed before applying them again with [git-am(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-am.html):
...
You can also edit a patch series with an interactive rebase. This is the same as [reordering a patch series using `format-patch`](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#reordering-patch-series "Reordering or selecting from a patch series"), so use whichever interface you like best.
...
The [git-bisect(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-bisect.html) command correctly handles history that includes merge commits. However, when the commit that it finds is a merge commit, the user may need to work harder than usual to figure out why that commit introduced a problem.
...
Instead of using [git-remote(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-remote.html), you can also choose just to update one branch at a time, and to store it locally under an arbitrary name:
...
will create a new branch named `example-master` and store in it the branch named `master` from the repository at the given URL. If you already have a branch named example-master, it will attempt to [fast-forward](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#fast-forwards "Fast-forward merges") to the commit given by example.com’s master branch. In more detail:

## git fetch and fast-forwards

In the previous example, when updating an existing branch, `git fetch` checks to make sure that the most recent commit on the remote branch is a descendant of the most recent commit on your copy of the branch before updating your copy of the branch to point at the new commit. Git calls this process a [fast-forward](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#fast-forwards "Fast-forward merges").
...
We saw above that `origin` is just a shortcut to refer to the repository that you originally cloned from. This information is stored in Git configuration variables, which you can see using [git-config(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-config.html):
...
Also note that the above configuration can be performed by directly editing the file `.git/config` instead of using [git-remote(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-remote.html).
...
See [git-config(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-config.html) for more details on the configuration options mentioned above and [git-fetch(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-fetch.html) for more details on the refspec syntax.
...
We start with the most important, the [object database](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object_database) and the [index](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_index).

## The Object Database

We already saw in [the section called “Understanding History: Commits”](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#understanding-commits "Understanding History: Commits") that all commits are stored under a 40-digit "object name". In fact, all the information needed to represent the history of a project is stored in objects with such names. In each case the name is calculated by taking the SHA-1 hash of the contents of the object. The SHA-1 hash is a cryptographic hash function. What that means to us is that it is impossible to find two different objects with the same name. This has a number of advantages; among others:
...
(See [the section called “Object storage format”](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#object-details "Object storage format") for the details of the object formatting and SHA-1 calculation.)

There are four different types of objects: "blob", "tree", "commit", and "tag".

- A ["blob" object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_blob_object) is used to store file data.
- A ["tree" object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_tree_object) ties one or more "blob" objects into a directory structure. In addition, a tree object can refer to other tree objects, thus creating a directory hierarchy.
- A ["commit" object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit_object) ties such directory hierarchies together into a [directed acyclic graph](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_DAG) of revisions—each commit contains the object name of exactly one tree designating the directory hierarchy at the time of the commit. In addition, a commit refers to "parent" commit objects that describe the history of how we arrived at that directory hierarchy.
- A ["tag" object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_tag_object) symbolically identifies and can be used to sign other objects. It contains the object name and type of another object, a symbolic name (of course!) and, optionally, a signature.

The object types in some more detail:

### Commit Object

The "commit" object links a physical state of a tree with a description of how we got there and why. Use the `--pretty=raw` option to [git-show(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-show.html) or [git-log(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-log.html) to examine your favorite commit:
...
Note that a commit does not itself contain any information about what actually changed; all changes are calculated by comparing the contents of the tree referred to by this commit with the trees associated with its parents. In particular, Git does not attempt to record file renames explicitly, though it can identify cases where the existence of the same file data at changing paths suggests a rename. (See, for example, the `-M` option to [git-diff(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-diff.html)).

A commit is usually created by [git-commit(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-commit.html), which creates a commit whose parent is normally the current HEAD, and whose tree is taken from the content currently stored in the index.

### Tree Object

The ever-versatile [git-show(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-show.html) command can also be used to examine tree objects, but [git-ls-tree(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-ls-tree.html) will give you more details:
...
(Note: in the presence of submodules, trees may also have commits as entries. See [Chapter 8, _Submodules_](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#submodules "Chapter 8. Submodules") for documentation.)

Note that the files all have mode 644 or 755: Git actually only pays attention to the executable bit.

### Blob Object

You can use [git-show(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-show.html) to examine the contents of a blob; take, for example, the blob in the entry for `COPYING` from the tree above:
...
Note that any tree or blob object can be examined using [git-show(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-show.html) with the <revision>:<path> syntax. This can sometimes be useful for browsing the contents of a tree that is not currently checked out.
...
A tag object contains an object, object type, tag name, the name of the person ("tagger") who created the tag, and a message, which may contain a signature, as can be seen using [git-cat-file(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-cat-file.html):
...
See the [git-tag(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-tag.html) command to learn how to create and verify tag objects. (Note that [git-tag(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-tag.html) can also be used to create "lightweight tags", which are not tag objects at all, but just simple references whose names begin with `refs/tags/`).
...
You can save space and make Git faster by moving these loose objects in to a "pack file", which stores a group of objects in an efficient compressed format; the details of how pack files are formatted can be found in [gitformat-pack(5)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/gitformat-pack.html).
...
The [git-gc(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-gc.html) command performs packing, pruning, and more for you, so is normally the only high-level command you need.

### Dangling objects

The [git-fsck(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-fsck.html) command will sometimes complain about dangling objects. They are not a problem.

The most common cause of dangling objects is that you’ve rebased a branch, or you have pulled from somebody else who rebased a branch—see [Chapter 5, _Rewriting history and maintaining patch series_](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#cleaning-up-history "Chapter 5. Rewriting history and maintaining patch series"). In that case, the old head of the original branch still exists, as does everything it pointed to. The branch pointer itself just doesn’t, since you replaced it with another one.
...
Before starting, verify that there is corruption, and figure out where it is with [git-fsck(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-fsck.html); this may be time-consuming.
...
The index is a binary file (generally kept in `.git/index`) containing a sorted list of path names, each with permissions and the SHA-1 of a blob object; [git-ls-files(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-ls-files.html) can show you the contents of the index:
...
1. The index contains all the information necessary to generate a single (uniquely determined) tree object.
    ...
    For example, running [git-commit(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-commit.html) generates this tree object from the index, stores it in the object database, and uses it as the tree object associated with the new commit.
...
3. It can efficiently represent information about merge conflicts between different tree objects, allowing each pathname to be associated with sufficient information about the trees involved that you can create a three-way merge between them.
    ...
    We saw in [the section called “Getting conflict-resolution help during a merge”](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#conflict-resolution "Getting conflict-resolution help during a merge") that during a merge the index can store multiple versions of a single file (called "stages"). The third column in the [git-ls-files(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-ls-files.html) output above is the stage number, and will take on values other than 0 for files with merge conflicts.
...
[Pitfalls with submodules](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#pitfalls-with-submodules)
...
The [git-submodule(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-submodule.html) command is available since Git 1.5.3. Users with Git 1.5.2 can look up the submodule commits in the repository and manually check them out; earlier versions won’t recognize the submodules at all.
...
- It adds the submodule’s clone path to the [gitmodules(5)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/gitmodules.html) file and adds this file to the index, ready to be committed.
...
High-level operations such as [git-commit(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-commit.html) and [git-restore(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-restore.html) work by moving data between the working tree, the index, and the object database. Git provides low-level operations which perform each of these steps individually.
...
The [git-update-index(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-update-index.html) command updates the index with information from the working directory. You generally update the index information by just specifying the filename you want to update, like so:
...
The previously introduced [git-add(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-add.html) is just a wrapper for [git-update-index(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-update-index.html).
...
NOTE! `git checkout-index` normally refuses to overwrite old files, so if you have an old version of the tree already checked out, you will need to use the `-f` flag (_before_ the `-a` flag or the filename) to _force_ the checkout.
...
You can examine the data represented in the object database and the index with various helper tools. For every object, you can use [git-cat-file(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-cat-file.html) to examine details about the object:
...
Each line of the `git ls-files --unmerged` output begins with the blob mode bits, blob SHA-1, _stage number_, and the filename. The _stage number_ is Git’s way to say which tree it came from: stage 1 corresponds to the `$orig` tree, stage 2 to the `HEAD` tree, and stage 3 to the `$target` tree.
...
Note that terminology has changed since that revision. For example, the README in that revision uses the word "changeset" to describe what we now call a [commit](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit_object).
...
Next step: get familiar with the object naming. Read [the section called “Naming commits”](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#naming-commits "Naming commits"). There are quite a few ways to name an object (and not only revisions!). All of these are handled in `sha1_name.c`. Just have a quick look at the function `get_sha1()`. A lot of the special handling is done by functions like `get_sha1_basic()` or the likes.
...
`git rev-list` is the original version of the revision walker, which _always_ printed a list of revisions to stdout. It is still functional, and needs to, since most new Git commands start out as scripts using `git rev-list`.
...
[Git explained](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#git-explained)

## Git explained

alternate object database

Via the alternates mechanism, a [repository](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_repository) can inherit part of its [object database](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object_database) from another object database, which is called an "alternate".

bare repository

A bare repository is normally an appropriately named [directory](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_directory) with a `.git` suffix that does not have a locally checked-out copy of any of the files under revision control. That is, all of the Git administrative and control files that would normally be present in the hidden `.git` sub-directory are directly present in the `repository.git` directory instead, and no other files are present and checked out. Usually publishers of public repositories make bare repositories available.

blob object

Untyped [object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object), e.g. the contents of a file.

branch

A "branch" is a line of development. The most recent [commit](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit) on a branch is referred to as the tip of that branch. The tip of the branch is [referenced](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_ref) by a branch [head](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_head), which moves forward as additional development is done on the branch. A single Git [repository](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_repository) can track an arbitrary number of branches, but your [working tree](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_working_tree) is associated with just one of them (the "current" or "checked out" branch), and [HEAD](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_HEAD) points to that branch.

cache

Obsolete for: [index](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_index).

chain

A list of objects, where each [object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object) in the list contains a reference to its successor (for example, the successor of a [commit](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit) could be one of its [parents](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_parent)).

changeset

BitKeeper/cvsps speak for "[commit](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit)". Since Git does not store changes, but states, it really does not make sense to use the term "changesets" with Git.

checkout

The action of updating all or part of the [working tree](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_working_tree) with a [tree object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_tree_object) or [blob](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_blob_object) from the [object database](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object_database), and updating the [index](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_index) and [HEAD](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_HEAD) if the whole working tree has been pointed at a new [branch](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_branch).

cherry-picking

In [SCM](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_SCM) jargon, "cherry pick" means to choose a subset of changes out of a series of changes (typically commits) and record them as a new series of changes on top of a different codebase. In Git, this is performed by the "git cherry-pick" command to extract the change introduced by an existing [commit](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit) and to record it based on the tip of the current [branch](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_branch) as a new commit.

clean

A [working tree](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_working_tree) is clean, if it corresponds to the [revision](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_revision) referenced by the current [head](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_head). Also see "[dirty](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_dirty)".

commit

As a noun: A single point in the Git history; the entire history of a project is represented as a set of interrelated commits. The word "commit" is often used by Git in the same places other revision control systems use the words "revision" or "version". Also used as a short hand for [commit object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit_object).

As a verb: The action of storing a new snapshot of the project’s state in the Git history, by creating a new commit representing the current state of the [index](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_index) and advancing [HEAD](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_HEAD) to point at the new commit.

commit graph concept, representations and usage

A synonym for the [DAG](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_DAG) structure formed by the commits in the object database, [referenced](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_ref) by branch tips, using their [chain](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_chain) of linked commits. This structure is the definitive commit graph. The graph can be represented in other ways, e.g. the ["commit-graph" file](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit_graph_file).

commit-graph file

The "commit-graph" (normally hyphenated) file is a supplemental representation of the [commit graph](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit_graph_general) which accelerates commit graph walks. The "commit-graph" file is stored either in the .git/objects/info directory or in the info directory of an alternate object database.

commit object

An [object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object) which contains the information about a particular [revision](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_revision), such as [parents](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_parent), committer, author, date and the [tree object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_tree_object) which corresponds to the top [directory](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_directory) of the stored revision.

commit-ish (also committish)

A [commit object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit_object) or an [object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object) that can be recursively [dereferenced](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_dereference) to a commit object. The following are all commit-ishes: a commit object, a [tag object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_tag_object) that points to a commit object, a tag object that points to a tag object that points to a commit object, etc.
...
Directed acyclic graph. The [commit objects](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit_object) form a directed acyclic graph, because they have parents (directed), and the graph of commit objects is acyclic (there is no [chain](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_chain) which begins and ends with the same [object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object)).

dangling object

An [unreachable object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_unreachable_object) which is not [reachable](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_reachable) even from other unreachable objects; a dangling object has no references to it from any reference or [object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object) in the [repository](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_repository).

dereference

Referring to a [symbolic ref](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_symref): the action of accessing the [reference](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_ref) pointed at by a symbolic ref. Recursive dereferencing involves repeating the aforementioned process on the resulting ref until a non-symbolic reference is found.

Referring to a [tag object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_tag_object): the action of accessing the [object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object) a tag points at. Tags are recursively dereferenced by repeating the operation on the result object until the result has either a specified [object type](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object_type) (where applicable) or any non-"tag" object type. A synonym for "recursive dereference" in the context of tags is "[peel](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_peel)".

Referring to a [commit object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit_object): the action of accessing the commit’s tree object. Commits cannot be dereferenced recursively.

Unless otherwise specified, "dereferencing" as it used in the context of Git commands or protocols is implicitly recursive.

detached HEAD

Normally the [HEAD](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_HEAD) stores the name of a [branch](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_branch), and commands that operate on the history HEAD represents operate on the history leading to the tip of the branch the HEAD points at. However, Git also allows you to [check out](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_checkout) an arbitrary [commit](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit) that isn’t necessarily the tip of any particular branch. The HEAD in such a state is called "detached".
...
A [working tree](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_working_tree) is said to be "dirty" if it contains modifications which have not been [committed](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit) to the current [branch](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_branch).

evil merge

An evil merge is a [merge](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_merge) that introduces changes that do not appear in any [parent](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_parent).

fast-forward

A fast-forward is a special type of [merge](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_merge) where you have a [revision](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_revision) and you are "merging" another [branch](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_branch)'s changes that happen to be a descendant of what you have. In such a case, you do not make a new [merge](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_merge) [commit](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit) but instead just update your branch to point at the same revision as the branch you are merging. This will happen frequently on a [remote-tracking branch](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_remote_tracking_branch) of a remote [repository](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_repository).

fetch

Fetching a [branch](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_branch) means to get the branch’s [head ref](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_head_ref) from a remote [repository](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_repository), to find out which objects are missing from the local [object database](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object_database), and to get them, too. See also [git-fetch(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-fetch.html).
...
Synonym for [repository](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_repository) (for arch people).

gitfile

A plain file `.git` at the root of a working tree that points at the directory that is the real repository. For proper use see [git-worktree(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-worktree.html) or [git-submodule(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-submodule.html). For syntax see [gitrepository-layout(5)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/gitrepository-layout.html).

grafts

Grafts enable two otherwise different lines of development to be joined together by recording fake ancestry information for commits. This way you can make Git pretend the set of [parents](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_parent) a [commit](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit) has is different from what was recorded when the commit was created. Configured via the `.git/info/grafts` file.

Note that the grafts mechanism is outdated and can lead to problems transferring objects between repositories; see [git-replace(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-replace.html) for a more flexible and robust system to do the same thing.

hash

In Git’s context, synonym for [object name](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object_name).

head

A [named reference](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_ref) to the [commit](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit) at the tip of a [branch](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_branch). Heads are stored in a file in `$GIT_DIR/refs/heads/` directory, except when using packed refs. (See [git-pack-refs(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-pack-refs.html).)

HEAD

The current [branch](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_branch). In more detail: Your [working tree](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_working_tree) is normally derived from the state of the tree referred to by HEAD. HEAD is a reference to one of the [heads](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_head) in your repository, except when using a [detached HEAD](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_detached_HEAD), in which case it directly references an arbitrary commit.

head ref

A synonym for [head](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_head).
...
A collection of files with stat information, whose contents are stored as objects. The index is a stored version of your [working tree](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_working_tree). Truth be told, it can also contain a second, and even a third version of a working tree, which are used when [merging](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_merge).

index entry

The information regarding a particular file, stored in the [index](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_index). An index entry can be unmerged, if a [merge](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_merge) was started, but not yet finished (i.e. if the index contains multiple versions of that file).

master

The default development [branch](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_branch). Whenever you create a Git [repository](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_repository), a branch named "master" is created, and becomes the active branch. In most cases, this contains the local development, though that is purely by convention and is not required.

merge

As a verb: To bring the contents of another [branch](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_branch) (possibly from an external [repository](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_repository)) into the current branch. In the case where the merged-in branch is from a different repository, this is done by first [fetching](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_fetch) the remote branch and then merging the result into the current branch. This combination of fetch and merge operations is called a [pull](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_pull). Merging is performed by an automatic process that identifies changes made since the branches diverged, and then applies all those changes together. In cases where changes conflict, manual intervention may be required to complete the merge.

As a noun: unless it is a [fast-forward](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_fast_forward), a successful merge results in the creation of a new [commit](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit) representing the result of the merge, and having as [parents](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_parent) the tips of the merged [branches](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_branch). This commit is referred to as a "merge commit", or sometimes just a "merge".

object

The unit of storage in Git. It is uniquely identified by the [SHA-1](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_SHA1) of its contents. Consequently, an object cannot be changed.

object database

Stores a set of "objects", and an individual [object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object) is identified by its [object name](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object_name). The objects usually live in `$GIT_DIR/objects/`.

object identifier (oid)

Synonym for [object name](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object_name).

object name

The unique identifier of an [object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object). The object name is usually represented by a 40 character hexadecimal string. Also colloquially called [SHA-1](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_SHA1).

object type

One of the identifiers "[commit](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit_object)", "[tree](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_tree_object)", "[tag](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_tag_object)" or "[blob](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_blob_object)" describing the type of an [object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object).

octopus

To [merge](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_merge) more than two [branches](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_branch).

orphan

The act of getting on a [branch](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_branch) that does not exist yet (i.e., an [unborn](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_unborn) branch). After such an operation, the commit first created becomes a commit without a parent, starting a new history.

origin

The default upstream [repository](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_repository). Most projects have at least one upstream project which they track. By default _origin_ is used for that purpose. New upstream updates will be fetched into [remote-tracking branches](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_remote_tracking_branch) named origin/name-of-upstream-branch, which you can see using `git branch -r`.

overlay

Only update and add files to the working directory, but don’t delete them, similar to how _cp -R_ would update the contents in the destination directory. This is the default mode in a [checkout](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_checkout) when checking out files from the [index](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_index) or a [tree-ish](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_tree-ish). In contrast, no-overlay mode also deletes tracked files not present in the source, similar to _rsync --delete_.
...
The list of identifiers, and other information, of the objects in a [pack](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_pack), to assist in efficiently accessing the contents of a pack.
...
After `attr:` comes a space separated list of "attribute requirements", all of which must be met in order for the path to be considered a match; this is in addition to the usual non-magic pathspec pattern matching. See [gitattributes(5)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/gitattributes.html).
...
A [commit object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit_object) contains a (possibly empty) list of the logical predecessor(s) in the line of development, i.e. its parents.

peel

The action of recursively [dereferencing](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_dereference) a [tag object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_tag_object).

pickaxe

The term [pickaxe](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_pickaxe) refers to an option to the diffcore routines that help select changes that add or delete a given text string. With the `--pickaxe-all` option, it can be used to view the full [changeset](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_changeset) that introduced or removed, say, a particular line of text. See [git-diff(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-diff.html).

plumbing

Cute name for [core Git](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_core_git).

porcelain

Cute name for programs and program suites depending on [core Git](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_core_git), presenting a high level access to core Git. Porcelains expose more of a [SCM](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_SCM) interface than the [plumbing](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_plumbing).

per-worktree ref

Refs that are per-[worktree](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_worktree), rather than global. This is presently only [HEAD](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_HEAD) and any refs that start with `refs/bisect/`, but might later include other unusual refs.

pseudoref

A ref that has different semantics than normal refs. These refs can be read via normal Git commands, but cannot be written to by commands like [git-update-ref(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-update-ref.html).

The following pseudorefs are known to Git:

- `FETCH_HEAD` is written by [git-fetch(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-fetch.html) or [git-pull(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-pull.html). It may refer to multiple object IDs. Each object ID is annotated with metadata indicating where it was fetched from and its fetch status.
- `MERGE_HEAD` is written by [git-merge(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-merge.html) when resolving merge conflicts. It contains all commit IDs which are being merged.

pull

Pulling a [branch](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_branch) means to [fetch](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_fetch) it and [merge](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_merge) it. See also [git-pull(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-pull.html).

push

Pushing a [branch](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_branch) means to get the branch’s [head ref](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_head_ref) from a remote [repository](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_repository), find out if it is an ancestor to the branch’s local head ref, and in that case, putting all objects, which are [reachable](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_reachable) from the local head ref, and which are missing from the remote repository, into the remote [object database](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object_database), and updating the remote head ref. If the remote [head](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_head) is not an ancestor to the local head, the push fails.

reachable

All of the ancestors of a given [commit](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit) are said to be "reachable" from that commit. More generally, one [object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object) is reachable from another if we can reach the one from the other by a [chain](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_chain) that follows [tags](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_tag) to whatever they tag, [commits](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit_object) to their parents or trees, and [trees](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_tree_object) to the trees or [blobs](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_blob_object) that they contain.

reachability bitmaps

Reachability bitmaps store information about the [reachability](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_reachable) of a selected set of commits in a packfile, or a multi-pack index (MIDX), to speed up object search. The bitmaps are stored in a ".bitmap" file. A repository may have at most one bitmap file in use. The bitmap file may belong to either one pack, or the repository’s multi-pack index (if it exists).

rebase

To reapply a series of changes from a [branch](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_branch) to a different base, and reset the [head](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_head) of that branch to the result.

ref

A name that points to an [object name](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object_name) or another ref (the latter is called a [symbolic ref](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_symref)). For convenience, a ref can sometimes be abbreviated when used as an argument to a Git command; see [gitrevisions(7)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/gitrevisions.html) for details. Refs are stored in the [repository](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_repository).
...
A reflog shows the local "history" of a ref. In other words, it can tell you what the 3rd last revision in _this_ repository was, and what was the current state in _this_ repository, yesterday 9:14pm. See [git-reflog(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-reflog.html) for details.

refspec

A "refspec" is used by [fetch](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_fetch) and [push](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_push) to describe the mapping between remote [ref](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_ref) and local ref. See [git-fetch(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-fetch.html) or [git-push(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-push.html) for details.

remote repository

A [repository](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_repository) which is used to track the same project but resides somewhere else. To communicate with remotes, see [fetch](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_fetch) or [push](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_push).

remote-tracking branch

A [ref](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_ref) that is used to follow changes from another [repository](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_repository). It typically looks like _refs/remotes/foo/bar_ (indicating that it tracks a branch named _bar_ in a remote named _foo_), and matches the right-hand-side of a configured fetch [refspec](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_refspec). A remote-tracking branch should not contain direct modifications or have local commits made to it.

repository

A collection of [refs](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_ref) together with an [object database](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object_database) containing all objects which are [reachable](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_reachable) from the refs, possibly accompanied by meta data from one or more [porcelains](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_porcelain). A repository can share an object database with other repositories via [alternates mechanism](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_alternate_object_database).

resolve

The action of fixing up manually what a failed automatic [merge](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_merge) left behind.

revision

Synonym for [commit](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit) (the noun).

rewind

To throw away part of the development, i.e. to assign the [head](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_head) to an earlier [revision](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_revision).
...
"Secure Hash Algorithm 1"; a cryptographic hash function. In the context of Git used as a synonym for [object name](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object_name).

shallow clone

Mostly a synonym to [shallow repository](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_shallow_repository) but the phrase makes it more explicit that it was created by running `git clone --depth=...` command.

shallow repository

A shallow [repository](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_repository) has an incomplete history some of whose [commits](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit) have [parents](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_parent) cauterized away (in other words, Git is told to pretend that these commits do not have the parents, even though they are recorded in the [commit object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit_object)). This is sometimes useful when you are interested only in the recent history of a project even though the real history recorded in the upstream is much larger. A shallow repository is created by giving the `--depth` option to [git-clone(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-clone.html), and its history can be later deepened with [git-fetch(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-fetch.html).

stash entry

An [object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object) used to temporarily store the contents of a [dirty](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_dirty) working directory and the index for future reuse.

submodule

A [repository](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_repository) that holds the history of a separate project inside another repository (the latter of which is called [superproject](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_superproject)).

superproject

A [repository](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_repository) that references repositories of other projects in its working tree as [submodules](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_submodule). The superproject knows about the names of (but does not hold copies of) commit objects of the contained submodules.

symref

Symbolic reference: instead of containing the [SHA-1](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_SHA1) id itself, it is of the format _ref: refs/some/thing_ and when referenced, it recursively [dereferences](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_dereference) to this reference. _[HEAD](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_HEAD)_ is a prime example of a symref. Symbolic references are manipulated with the [git-symbolic-ref(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git-symbolic-ref.html) command.

tag

A [ref](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_ref) under `refs/tags/` namespace that points to an object of an arbitrary type (typically a tag points to either a [tag](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_tag_object) or a [commit object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit_object)). In contrast to a [head](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_head), a tag is not updated by the `commit` command. A Git tag has nothing to do with a Lisp tag (which would be called an [object type](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object_type) in Git’s context). A tag is most typically used to mark a particular point in the commit ancestry [chain](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_chain).

tag object

An [object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object) containing a [ref](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_ref) pointing to another object, which can contain a message just like a [commit object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit_object). It can also contain a (PGP) signature, in which case it is called a "signed tag object".

topic branch

A regular Git [branch](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_branch) that is used by a developer to identify a conceptual line of development. Since branches are very easy and inexpensive, it is often desirable to have several small branches that each contain very well defined concepts or small incremental yet related changes.

tree

Either a [working tree](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_working_tree), or a [tree object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_tree_object) together with the dependent [blob](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_blob_object) and tree objects (i.e. a stored representation of a working tree).

tree object

An [object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object) containing a list of file names and modes along with refs to the associated blob and/or tree objects. A [tree](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_tree) is equivalent to a [directory](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_directory).

tree-ish (also treeish)

A [tree object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_tree_object) or an [object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object) that can be recursively [dereferenced](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_dereference) to a tree object. Dereferencing a [commit object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit_object) yields the tree object corresponding to the [revision](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_revision)'s top [directory](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_directory). The following are all tree-ishes: a [commit-ish](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_commit-ish), a tree object, a [tag object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_tag_object) that points to a tree object, a tag object that points to a tag object that points to a tree object, etc.

unborn

The [HEAD](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_HEAD) can point at a [branch](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_branch) that does not yet exist and that does not have any commit on it yet, and such a branch is called an unborn branch. The most typical way users encounter an unborn branch is by creating a repository anew without cloning from elsewhere. The HEAD would point at the _main_ (or _master_, depending on your configuration) branch that is yet to be born. Also some operations can get you on an unborn branch with their [orphan](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_orphan) option.

unmerged index

An [index](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_index) which contains unmerged [index entries](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_index_entry).

unreachable object

An [object](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_object) which is not [reachable](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_reachable) from a [branch](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_branch), [tag](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_tag), or any other reference.

upstream branch

The default [branch](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_branch) that is merged into the branch in question (or the branch in question is rebased onto). It is configured via branch.<name>.remote and branch.<name>.merge. If the upstream branch of _A_ is _origin/B_ sometimes we say "_A_ is tracking _origin/B_".

working tree

The tree of actual checked out files. The working tree normally contains the contents of the [HEAD](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#def_HEAD) commit’s tree, plus any local changes that you have made but not yet committed.
...
[Todo list](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/user-manual.html#todo-list)
...
- some of `technical/`?
- hooks
- list of commands in [git(1)](file:///C:/Program%20Files/Git/mingw64/share/doc/git-doc/git.html)
